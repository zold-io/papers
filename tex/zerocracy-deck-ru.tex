...
об индивидуальных компетенциях каждого программиста, а затем их найма, увольнения
...
\footnote{%
  ...
  на 6\% каждый год. Мы планируем занять доминирующую позицию в сегменте Robotic Process Automation (RPA).
...
вещей --- их проекты проваливаются, а программисты плохо мотивированы
