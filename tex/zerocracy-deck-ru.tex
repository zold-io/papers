...
ожидаемый функционал или отстают в качестве. Недостаточная техническая компетенция команды лишь изредка является
...
Первая версия была создана в 2010, а в 2011 была подана заявка
...
которая устаняла недостатки первой, однако и она оказалась недостаточно
...
автор нескольких книг по объектно-ориентированному программированию, в том числе на русском языке;
