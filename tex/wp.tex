...
\footnotetext{% ETH
  ...
  BitFalls, May 2017,
  \url{https://goo.gl/B3ceVU}. Note that the figure here includes transactions executing contracts, and so is higher than transactions only involving currency transfer.
}
\footnotetext{% LTC
