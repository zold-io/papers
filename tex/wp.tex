...
% multiple \footnotemark causes problems with the counter. We have to increment the counter by -n, where n is the number of \footnotemark we have.
\addtocounter{footnote}{-8}

% we must manually \stepcounter{footnote} for each \footnotetext
