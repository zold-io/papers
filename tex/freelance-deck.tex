...
\slide{
  ...
  \topic{zred}{IPR Issues}{
    While full-time employees are bound by multi-page NDAs and contracts,
...
\slide{
  ...
  \topic{zgreen}{Mentorship}{
    ...
    who already know how the system works, which ensures easy
    adoption of new members into our community and our quality expectations.}
  ...
  \topic{zgreen}{Double Peer Reviews}{
    Each software code increment, also known as a pull request, has to be
...
\slide{
  ...
  \topic{zblue}{NDAs}{
    ...
    obtain while working in a project. Moreover, a customer may require them
  ...
  \topic{zblue}{Work Contracts}{
    ...
    freelancers are bound by the contract they accept and sign when they create their
  ...
  \topic{zblue}{KYC}{
    ...
    one of our sub-contractors, for example \href{https://www.yoti.com}{Yoti} (based in the UK); full document
  ...
  \topic{zblue}{``Work For Hire''}{
    ...
    that all intellectual property rights are protected from the first day of the project.
  }
  ...
  \topic{zblue}{Microtasking}{
    ...
    of the source code in his or her personal possession for a long time.
  }
\end{multicols}}
...
\slide{
  ...
  \topic{zblue}{Telegram Chat}{
    ...
    we discuss how the platform works, resolve issues, and provide help
    to newcomers.}
\end{multicols}}
  ...
  \begin{tikzpicture}
    \node (invoice) {
      ...
      \fcolorbox{gray}{paper}{\begin{minipage}{10em}
        ...
        2 & Broken encryption reported & \$18.40 \\
    ...
    \node [anchor=west] at (invoice.east) {
      \begin{minipage}{4em}\normalsize\raggedright
        ...
        is \$8.00 per microtask. The management fee usually equals 25\% of
...
\slide{
  ...
  \topic{zred}{Centralization}{
    ...
    choosing who to work for. If there is only one employer, they turn from
  ...
  \topic{zred}{Envy}{
    Full-timers often see freelancers as someone who does nothing, sits at the
