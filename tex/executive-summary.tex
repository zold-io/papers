...
human workforce with computers. The target market is very similar to the one
...
changing requirements; and 4) Ignoring facts and statistics.
...
result of this chaos we have restarts (94\% of projects!), cost overruns, and time
overruns. Technology incompetence is the root cause of project failures only in
7\% of cases. In almost all other cases the management is the source of trouble.

Thus, the key pain point of software projects all over the world is a lack of proper
...
leads, project managers, program managers and everybody else who manages
...
the project portfolio management market is \$2.5B (although, it includes services
...
This \href{https://www.capterra.com/project-management-software/#infographic}{report}
...
world. At the same time, there are \href{https://sostats.github.io/}{about five million accounts} registered at the
...
number of programmers in the world who make a living by regularly writing code.
...
years of experience are nearly twice as likely to work remote as developers with
...
The uniqueness of the Zerocracy management model and its strict focus on quality
and results makes it difficult to engage a large number of programmers. Thanks
...
Competitors may quickly catch up, because the concept has been very visible and
transparent since its market launch.

\section{Team}

Yegor Bugayenko's (CEO) \href{http://www.yegor256.com}{blog} has over 50,000/mo unique visitors, most of them from the
software industry: programmers, managers, founders. Besides that, Yegor
Bugayenko is the author of \href{https://amzn.to/2bYXQy7}{Elegant Objects} books about object-oriented
...
processing, central to Zerocracy's core technology. Larson is also a
\href{https://www.theatlantic.com/technology/archive/2015/05/the-humanists-paradox/391622/}{writer} and
speaker on issues in AI, and will be active in evangelizing Zerocracy's
technology.
...
Yegor has some experience in making products for the software industry. For example,
there are a few of his recent ``pet'' projects:
\href{https://www.rultor.com}{rultor.com} (300+ customers),
...
Our financial objective is \$400M revenue with a profit margin over 80\%. Such a high
...
The long-term goal is to expand our solution to other verticals, including
...
\begin{itemize}\itemsep0em
  ...
  \item Management always has enough information to make decisions;
...
a fixed price of \$4.00/task. Based on our experience, in an average project an average
...
working 20 days a month. This means \$4,000 monthly income for a programmer
and \$1,280 revenue for Zerocracy (we will charge \$8 per ticket).

Thus, every \$100K invested in sandbox projects produces 30 graduated programmers,
