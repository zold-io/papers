...
Since its release in 2009, \href{https://bitcoin.org/}{Bitcoin} turned from
``a libertarian fairy tale'' and ``a simple Silicon Valley exercise in hype''
into ``a catalyst to reshape the financial system in ways that are more
...
two obvious disadvantages present in the majority of cryptocurrencies:
...
\href{https://ethereum.org/}{Eth\-ereum},
...
total supply in order ``to protect against inflationary forces,''
...
actively contribute to the Zerocracy ecosystem, the development of Zold software,
...
advantages and the popularity of the Zerocracy platform among programmers
