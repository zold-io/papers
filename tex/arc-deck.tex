...
\slide{%
  ...
  \begin{tikzpicture}
    ...
    \node (slack) at (4,12) {\includegraphics[height=3em]{../images/slack.pdf}};
    \node (github) at (8,12) {\includegraphics[height=3em]{../images/github.pdf}};
    \node (telegram) at (12,12) {\includegraphics[height=3em]{../images/telegram.pdf}};
