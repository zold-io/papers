...
\slide{We already processed transactions for over \$600K up to date, managed
...
\slide{We believe that computers must replace a traditional thousands-years-old management paradigm, which is not working any more.}

\slide{\large\begin{tabular}{ccc}
  \makecell{
...
\slide{%
  ...
  \Large 408.692.4742\\
  \Large \href{mailto:team@zerocracy.com}{team@zerocracy.com}}
