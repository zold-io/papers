...
\slide{
  ...
  \fact{zgreen}{Zold was listed on AlterDice}{%
    ...
    exchanges soon, we are in the negotiation process with over a dozen
    of them. By the way, thanks to the growth of BTC, the rate of
    ZLD is \$1.51 now.}
  \fact{zgreen}{Online Risk Manager}{%
    We created a new satellite project for Zerocracy customers,
  ...
  \fact{zgreen}{Full Integration with Bitcoin}{%
    ...
    private keys, sends and receives Bitcoin payments. We still use
