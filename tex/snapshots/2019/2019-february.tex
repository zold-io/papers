...
\slide{
  ...
  \fact{zgreen}{Revenue Almost Doubled Up}{%
    ...
    in Java, Ruby and Python. The number of programmers is also growing,
    and we see new faces every day. The number of active contributors
  ...
  \fact{zgreen}{Zold Is a Primary Payment Tool}{%
    ...
    are not very stable, to say the least.}
